...
Automated end-to-end test suite for SwiftTranslator (Singlish to Sinhala conversion) using Playwright.
...
```
.
├── IT23263994-test-cases.spec.js    # Main test file
├── IT23263994.xlsx                   # Test case documentation (Excel)
├── README.md                         # This file
